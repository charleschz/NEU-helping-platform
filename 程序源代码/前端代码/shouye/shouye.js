...
Page({
  ...
  data: {
    ...
    imgUrls: [
      ...
      "/images/shouye/lunbotu2.jpg",
      "/images/shouye/lunbotu3.jpg",
      "/images/shouye/lunbotu4.jpg",
    ],
  ...
  onLoad: function (options) {
    ...
    this.setData({
      msgList: [
        {
          url: "url", title: "校园头条：东北大学举行“相约白山黑水，共庆97华诞”云校庆活动"
        },
        {
          url: "url", title: "校园头条：东北大学在2020年国际大学生数学建模竞赛中再获佳绩"
        },
        { url: "url", title: "校园头条：计算机学院开展“职涯领航大讲堂”系列活动" }]
    });
    //获取实时时间天气数据
    BMap.weather({
      fail: function(e){
